...
- Added support of Strings extraction from code to Crowdin
- Dependencies update

## [2.1.0]

- Settings reorder
- Add translations mismatch error message
- Dependencies update
...
- Allow branches with unsupported characters in the name
